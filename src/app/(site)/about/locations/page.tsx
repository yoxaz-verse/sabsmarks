    ...
    <div className="flex flex-col min-h-screen bg-stone-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:py-32 w-full">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#18395f] mb-6">Global Presence</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            {locations.map((loc) => (
              <button
                ...
                className={`text-left px-6 py-4 text-[17px] font-bold transition-all duration-300 flex justify-between items-center ${
                  activeId === loc.id
                    ? "bg-[#df8c20] text-white shadow-md scale-[1.02] origin-left"
                    : "bg-white text-[#18395f] hover:bg-stone-100 border border-stone-100"
                }`}
              >
                {loc.city}
          ...
          <div className="w-full lg:w-2/3 flex flex-col bg-white rounded-2xl shadow-xl overflow-hidden border border-stone-100">
            ...
            <div className="p-8 md:p-12 bg-[#18395f] text-white relative">
              <div className="absolute top-0 right-12 transform -translate-y-1/2 flex items-center justify-center w-16 h-16 bg-[#df8c20] rounded-full shadow-lg border-4 border-[#18395f]">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 space-y-4">
                  <div className="flex items-start gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#df8c20] mt-1 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex-1 space-y-4">
                  <div className="flex items-center gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#df8c20] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
