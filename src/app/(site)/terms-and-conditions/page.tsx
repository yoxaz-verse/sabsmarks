      ...
      <section className="site-section">
        <div className="site-container">
          <article className="site-prose mx-auto max-w-4xl rounded-[1.5rem] border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--surface-raised)_82%,transparent)] px-6 py-8 shadow-sm md:px-10 md:py-12">
            <h2 className="text-2xl font-bold leading-tight text-ink md:text-3xl">Terms & Conditions</h2>
            <p>
              We may revise these Terms of Use at any time in our sole discretion. Revised Terms of Use will be posted at the Terms of Use link (i.e., this webpage that you are currently viewing) or elsewhere in this Website. The revised Terms of Use will be effective when posted, unless we explicitly state otherwise. Your continued access to and use of this Website following any changes to these Terms of Use constitutes your agreement to the revisions. You are responsible for being aware of any revisions to our Terms of Use through checking this webpage.
            </p>

            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">About Sabs Marks JVS & Co.</h2>
            <p>
              “Sabs Marks JVS & Co” “us”, “our” and “we” as used on this Website refer to one or more member firms of Sabs Marks JVS & Co their respective related entities . The entities in the Sabs Marks JVS & Co organisation are separate and independent and each is liable only for its own acts and omissions and not those of any other entity.
            </p>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Use of Content</h2>
            <p>
              This Website (including without limitation any content or other part thereof) contains general information only and by making this Website available, Deloitte is not rendering professional advice or services. Before making any decision or taking action that might affect your finances or business, you should consult a qualified professional advisor.
            </p>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Restrictions</h2>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Intellectual Property Rights; No use of Sabs Marks JVS & Co names or logos</h2>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Privacy Statement</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Termination</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Links</h2>
            <p>
              Certain links on this Website may lead to websites, resources or tools maintained by third parties over whom we have no control, including, without limitation, those maintained by other entities within the Deloitte organisation or individual personnel of such entities. We do not bear any responsibility for the content, accuracy or security of any websites that are linked to this Website. Any links to any such websites, resources and tools should not be construed as an endorsement of them or their content by us.
            </p>

            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Disclaimer and Limitations of Liability</h2>
            <p>
            ...
            <p>The above Disclaimer and Limitation of Liability apply not only to us but also to each other entity within the Deloitte organisation and to our and their respective personnel.</p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Additional Terms</h2>
            <p>
