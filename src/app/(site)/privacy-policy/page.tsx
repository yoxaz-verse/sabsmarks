      ...
      <section className="site-section">
        <div className="site-container">
          <article className="site-prose mx-auto max-w-4xl rounded-[1.5rem] border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--surface-raised)_82%,transparent)] px-6 py-8 shadow-sm md:px-10 md:py-12">
            <h2 className="text-2xl font-bold leading-tight text-ink md:text-3xl">Privacy Policy</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Why We Need Personal Data</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">How We Collect Personal Data</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Categories of Personal Data We Collect</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">AI and Data Processing</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Children&apos;s Data</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Legal Grounds for Processing</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Sharing Personal Data with Third Parties</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Your Data Protection Rights</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Cookies</h2>
            <p>
            ...
            <h2 className="mt-10 text-2xl font-bold leading-tight text-ink">Changes to This Privacy Policy</h2>
            <p>
