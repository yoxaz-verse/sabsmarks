...
export async function Footer() {
  ...
  const brand = settings?.brand_name ?? "Sabs Marks JVS & Co";
    ...
    <footer className="w-full bg-stone-50 border-t border-stone-200 mt-20">
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-12 md:py-20">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            <p className="text-[14px] leading-relaxed text-stone-600 pr-4">
              {brand} provides strategic accounting, taxation, audit, compliance, and business advisory services tailored to help businesses grow with confidence.
            </p>
          </div>
          ...
          <div className="lg:col-span-3 grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex flex-col gap-4 text-[14px] font-medium text-stone-600">
                <Link href="/about" className="hover:text-[#18395f] transition-colors">About</Link>
                <Link href="/practice-areas" className="hover:text-[#18395f] transition-colors">Services</Link>
                <Link href="/about/team" className="hover:text-[#18395f] transition-colors">Leadership</Link>
                <Link href="/about/locations" className="hover:text-[#18395f] transition-colors">Location</Link>
              </div>
            </div>
            <div>
        ...
        <div className="mt-16 bg-white p-8 rounded-2xl shadow-sm border border-stone-100 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="https://www.linkedin.com/company/sabs-marks-jvs-co/"
            target="_blank"
            rel="noreferrer"
            aria-label="LinkedIn"
      ...
      <div className="bg-white border-t border-stone-200">
        <div className="mx-auto max-w-7xl px-6 py-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm font-medium text-stone-500">Copyright © {new Date().getFullYear()} {brand}. All rights reserved.</p>
